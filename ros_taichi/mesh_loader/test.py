...
if __name__ == "__main__":
    ...
    mesh_model = LoadSTL("model/forearm.stl")  # Load STL model
    ...
    # for mesh in mesh.geometry.keys():
    #     print(mesh)
    # print(faces)
    # print(normals)

    # mesh_combined = tm.load("model/forearm.dae", force="mesh")
    ...
    while window.running:
        ...
        scene.lines(x_axis, color=(1, 0, 0), width=2)
        scene.lines(y_axis, color=(0, 1, 0), width=2)
        scene.lines(z_axis, color=(0, 0, 1), width=2)
